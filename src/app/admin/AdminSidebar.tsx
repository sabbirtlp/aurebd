  ...
  return (
    <>
      ...
      <div className={styles.mobileHeader}>
        <Link href="/admin">
          <Image src="/images/logo-v2.webp" alt="Aurea BD Logo" width={120} height={40} style={{ objectFit: "contain" }} />
        </Link>
      ...
      <aside className={`${styles.sidebar} ${isOpen ? styles.open : ""}`}>
        <div className={styles.sidebarLogo}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", width: "100%" }}>
            <Link href="/">
              <Image src="/images/logo-v2.webp" alt="Aurea BD Logo" width={160} height={50} style={{ objectFit: "contain" }} />
            </Link>
