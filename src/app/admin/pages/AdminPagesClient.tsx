    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "serums_url", label: "Serums Link", type: "text", placeholder: "e.g. /shop?category=Radiance%20Serums" },
          { key: "serums_img", label: "Serums Image", type: "image" },
          { key: "creams", label: "Creams Label", type: "text", placeholder: "e.g. Hydration Creams" },
          { key: "creams_url", label: "Creams Link", type: "text", placeholder: "e.g. /shop?category=Hydration%20Creams" },
          { key: "creams_img", label: "Creams Image", type: "image" },
          { key: "uv", label: "UV Label", type: "text", placeholder: "e.g. UV Protection" },
          { key: "uv_url", label: "UV Link", type: "text", placeholder: "e.g. /shop?category=UV%20Protection" },
          { key: "uv_img", label: "UV Image", type: "image" },
          { key: "essentials", label: "Essentials Label", type: "text", placeholder: "e.g. Skin Essentials" },
          { key: "essentials_url", label: "Essentials Link", type: "text", placeholder: "e.g. /shop?category=Skin%20Essentials" },
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "col_1_url", label: "Collection 1 URL", type: "text" },
          { key: "col_2", label: "Collection 2 Label", type: "text" },
          { key: "col_2_url", label: "Collection 2 URL", type: "text" },
          { key: "col_3", label: "Collection 3 Label", type: "text" },
          { key: "col_3_url", label: "Collection 3 URL", type: "text" },
          { key: "col_4", label: "Collection 4 Label", type: "text" },
          { key: "col_4_url", label: "Collection 4 URL", type: "text" },
